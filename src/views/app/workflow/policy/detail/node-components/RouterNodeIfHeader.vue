...
<template>
  <div>
    ...
    <div class="flex flex-row pt-3 px-12">
      <div class="w-full">
        <div class="cursor-pointer bg-secondary w-6 h-6 rounded-full" @click="showUpdateHeaderModal">
      ...
      <div>
        <div class="cursor-pointer bg-secondary w-6 h-6 rounded-full" @click="updateDetailModal">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
               stroke="currentColor" class="size-6">
